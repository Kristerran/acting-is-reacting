      ...
      <h5 style={styles.textStyle}>
        ...
        <nav style={styles.navStyle}>
            <ul style={styles.listStyle}>
                <li id='github'>
                    <a style={styles.aStyle} href="https://github.com/Kristerran">
                ...
                <li style={styles.liStyle} id='linkedin'>
                    <a style={styles.aStyle} href="https://www.linkedin.com/in/kris-terran-baily">
                ...
                <li style={styles.liStyle} id='instagram'>
                    <a style={styles.aStyle} href="https://www.instagram.com/kristerrandeveloper/">
